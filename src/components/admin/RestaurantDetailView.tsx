          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-xs space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-1 bg-[#078A55] text-white rounded hover:bg-[#067347]"
                title="Add Category"
              >
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-xs flex items-center justify-between">
              ...
              {selectedCategoryId && (
                <button
                  ...
                  className="px-3 py-1.5 bg-[#078A55] hover:bg-[#067347] text-white text-xs font-medium rounded-lg flex items-center gap-1.5 shadow-xs"
                >
